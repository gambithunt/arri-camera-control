...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "CameraMocks", dependencies: ["ARRICAPKit", "CameraDiscovery", "CameraDomain", "CameraDiagnostics", "CameraSession", "CameraFeatures"]),
        ...
        .testTarget(name: "CameraMocksTests", dependencies: ["CameraMocks", "CameraFeatures"])
    ]
)
